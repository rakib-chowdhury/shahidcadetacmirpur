                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="panel-title">Edit About Us Info</h2>
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" method="post" enctype="multipart/form-data"
                                          action="<?= site_url('admin/about_edit_post')?>">
                                        <div class="form-group">
                                            <label for="control-label col-md-3">Image</label>

                                            <input onchange="readURL(this);" type="file" id="slider_image"
                                                   class="dropify" name="image" data-default-file="<?= base_url() ?>assets/images/about_us/<?= $about_us_info[0]->image ?>">
                                            ...
                                            <!--                                        <img style="display: none; padding-top: 5px;" id="show_img"
                                                ...
                                                <span id="p_img_err2" style="color: red; ">
                                                    <p id="image_size" style="color: red; ">
                                                        <?php echo "Image must be 848 x 460 format(Not More Than 1 MB)"; ?>
                                                    </p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <textarea class="summernote" name="who_we_are" required id="who_we_are"
                                                          ...
                                                          data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'><?= $about_us_info[0]->who_we_are ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <textarea class="summernote" name="why_us" required id="why_us"
                                                          data-plugin-summernote
                                                          data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'><?= $about_us_info[0]->why_us ?></textarea>
                                            </div>
                                        </div>
                                        <input type="hidden" class="form-control" id="id"
                                               name="id" value="<?= $about_us_info[0]->id ?>">
                                        <div class="form-group">
