                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" method="post"
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="inputDefault"><span
                                                    style="color: red">*</span>Cell</label>
                                            <div class="col-md-6">
                                                <input type="text" onkeyup="checkNumber(this.id)" maxlength="11" minlength="11" class="form-control" required id="cell" name="cell"
                                                       placeholder="cell">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="inputDefault"><span
                                                    style="color: red">*</span>Bkash</label>
                                            <div class="col-md-6">
                                                <input type="text" onkeyup="checkNumber(this.id)" maxlength="11" minlength="11" class="form-control" required id="bkash" name="bkash"
