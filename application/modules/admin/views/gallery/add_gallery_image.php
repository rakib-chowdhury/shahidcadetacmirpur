                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="panel-title">Add Gallery Info</h2>
<!--                                    <div style="padding-top: 10px">-->
<!--                                        <a href="--><?//= base_url() ?><!--admin/gallery_category_add" class="btn btn-success btn-rounded">Add New Category</a>-->
<!--                                    </div>-->
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" method="post"
                                          action="gallery_add_post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="class_start"><span
                                                    style="color: red">*</span>Select Category</label>
                                            <div class="col-md-6">
                                                <select id="category" name="category" class="select2-container form-control select2" required>
                                                    <option value="">Choose A Category</option>
                                                    <?php foreach ($category as $u) { ?>
                                                        <option value="<?= $u->category_name ?>"><?= $u->category_name ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
