                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="panel-title">Add Meal Name</h2>
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" method="post"
                                          action="meal_name_add_post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="meal_name"><span
                                                    style="color: red">*</span>Meal Name</label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" required id="meal_name"
                                                       name="meal_name" placeholder="Meal Name">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="time"><span
                                                    style="color: red">*</span>Time</label>
                                            <div class="col-md-6">
