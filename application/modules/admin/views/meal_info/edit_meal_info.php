                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" required id="b_details"
                                                           name="b_details" value="<?= $meal_info[0]->b_details ?>" placeholder="Details">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" required id="t1_details"
                                                           name="t1_details" value="<?= $meal_info[0]->t1_details ?>"  placeholder="Details">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" required id="details"
                                                           name="l_details" value="<?= $meal_info[0]->l_details ?>" placeholder="Details">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" required id="details"
                                                           name="t2_details" value="<?= $meal_info[0]->t2_details ?>" placeholder="Details">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" required id="details"
                                                           name="d_details" value="<?= $meal_info[0]->d_details ?>" placeholder="Details">
                                                </div>
                                            </div>
                                        </div>
