                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="panel-title">Add Weekly Syllabus Info</h2>
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" method="post"
                                          action="weekly_syllabus_add_post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="inputDefault"><span
                                                    style="color: red">*</span>Syllabus File</label>
                                            <div class="col-md-6">
                                                <input type="file" class="form-control" required id="weekly_syllabus"
