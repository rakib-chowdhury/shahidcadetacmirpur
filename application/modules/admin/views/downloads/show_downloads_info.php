                ...
                <?php if($medium_info == null){echo 'No Data Found';}else{ ?>
                    <?php foreach ($medium_info as $key=>$row) { ?>
                        <tr class="gradeX">
                            <td><?= $key+1 ?></td>
                            <td><?= $row->medium ?></td>
                            <td><?= $row->student_cat ?></td>
                            <td><?= $row->admission_charge ?></td>
                            <td>
                                ...
                                <a href="<?= base_url() ?>admin/edit_medium_info/<?= $row->id ?>" style="padding-left: 30px">
                                            ...
                                            <div class="modal-body">
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding:5px;"><?= $row->student_cat ?></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding:5px;"><?= $row->admission_charge ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td style="padding:5px;">Monthly Salary</td>
                                                        <td style="padding:5px;"><?= $row->monthly_salary ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding:5px;">Advance Payment</td>
                                                        <td style="padding:5px;"><?= $row->advance_payment ?></td>
                                                    </tr>
