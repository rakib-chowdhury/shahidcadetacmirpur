...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Show Weekly Result Info</span></li>
            </ol>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Show Weekly Result Info</h2>
            <hr>
            <div>
                <a href="<?= base_url() ?>admin/weekly_result_add" class="btn btn-success btn-rounded">Add Weekly Result Info</a>
            </div>
        </header>
        <div class="panel-body">
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
                ...
                <tbody>
                <?php if($weekly_result_info == null){echo 'No Data Found';}else{ ?>
                <?php foreach ($weekly_result_info as $key=>$row) { ?>
                <tr class="gradeX">
                    <td><?= $key+1 ?></td>
                    <td><?= $row->year_id ?></td>
                    ...
                    <td><?= $row->medium ?></td>
                    <td><?= $row->weekly_result ?></td>
                    <td>
                        <a href="<?= base_url() ?>admin/edit_weekly_result_info/<?= $row->id ?>" style="padding-left: 40px" >
                                <span data-toggle="tooltip" data-placement="top" title="Replace"
                                      class="glyphicon glyphicon-edit"></span>
                        </a>&nbsp;
                        <a href="<?= base_url() ?>admin/delete_weekly_result_info/<?= $row->id ?>"
