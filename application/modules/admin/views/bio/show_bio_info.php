...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Show Home Page Bio</span></li>
            </ol>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Show Home Page Bio</h2>
            <hr>
            <?php if(sizeof($bio_info) == 0) { ?>
            <div>
                <a href="<?= base_url() ?>admin/bio_add" class="btn btn-success btn-rounded">Add Bio</a>
            </div>
            <?php } ?>
        </header>
        <div class="panel-body">
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
                ...
                <tbody>
                <?php if($bio_info == null){echo 'No Data Found';}else{ ?>
                <?php foreach ($bio_info as $key=>$row) { ?>
                <tr class="gradeX">
                    <td><?= $key+1 ?></td>
                    <td><?= $row->bio ?></td>
                    <td>
                        <a href="<?= base_url() ?>admin/edit_bio_info/<?= $row->id ?>" >
                                <span data-toggle="tooltip" data-placement="top" title="Edit"
                                      class="glyphicon glyphicon-edit"></span>
                        </a>&nbsp;
                        <a href="<?= base_url() ?>admin/delete_bio_info/<?= $row->id ?>"
