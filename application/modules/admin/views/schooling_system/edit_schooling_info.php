    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Schooling Info</span></li>
            </ol>
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="panel-title">Edit Schooling Info</h2>
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" method="post" enctype="multipart/form-data"
                                          action="<?= site_url('admin/schooling_edit_post')?>">
                                        <div class="form-group">
                                            <label for="control-label col-md-3">Rules & Facilities</label>

                                            <input onchange="readURL(this);" type="file" id="slider_image"
                                                   class="dropify" name="rules_facilities" data-default-file="<?= base_url() ?>assets/images/schooling_system/<?= $schooling_info[0]->rules_facilities ?>">
                                        ...
                                        <div class="form-group">
                                            <label for="control-label col-md-3">Parent's Responsibilities</label>

                                            <input onchange="readURL(this);" type="file" id="slider_image"
                                                   class="dropify" name="parent_responsibility" data-default-file="<?= base_url() ?>assets/images/schooling_system/<?= $schooling_info[0]->parent_responsibility ?>">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"><span style="color: red">*</span>Residential Facilities</label>
                                            <div class="col-md-8">
                                                <textarea class="summernote" name="residential_facilities" required id="residential_facilities"
                                                          data-plugin-summernote
                                                          data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'><?= $schooling_info[0]->residential_facilities ?></textarea>
                                            </div>
                                        </div>
                                        <input type="hidden" class="form-control" id="id"
                                               name="id" value="<?= $schooling_info[0]->id ?>">
                                        <div class="form-group">
