    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Schooling System Info</span></li>
            </ol>
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="panel-title">Add Schooling System Info</h2>
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" method="post"
                                          action="schooling_system_add_post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="control-label col-md-3"><span style="color: red">*</span>Rules & Facilities</label>

                                            <input required onchange="readURL(this);" type="file" id="slider_image"
                                                   class="dropify" name="rules_facilities" data-default-file="">
                                        ...
                                        <div class="form-group">
                                            <label for="control-label col-md-3"><span style="color: red">*</span>Parent’s Responsibilities</label>

                                            <input required onchange="readURL(this);" type="file" id="slider_image"
                                                   class="dropify" name="parent_responsibilities" data-default-file="">
                                                <span id="empty_image_msg"
                                                      style="display: none;color: red;">Input Image</span>
                                                <span id="p_img_err2" style="color: red; ">
                                                    <p id="image_size" style="color: red; ">
...
<script>
    ...
    function readURL(input) {
        if (input.files && input.files[0]) {
            ...
            if (input.files[0]['size'] > 2097152) {///1mb=1048576 bytes
                img = false;
            }
            if (img == false) {
                var x = document.getElementById('p_img_err2');
                x.style.color = 'red';
                x.innerText = 'Image should be png/PNG/jpg/JPG/jpeg/JPEG format and Image should be less than 2mb.';
