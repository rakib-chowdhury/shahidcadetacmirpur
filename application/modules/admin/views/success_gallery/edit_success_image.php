                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="panel-title">Edit Gallery Image</h2>
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" method="post" enctype="multipart/form-data"
                                          action="<?= site_url('admin/success_gallery_edit_post')?>">
                                        <div class="form-group">
                                            <label for="control-label col-md-3">Image</label>

                                            <input onchange="readURL(this);" type="file" id="slider_image"
                                                   class="dropify" name="image" data-default-file="<?= base_url() ?>assets/images/success_gallery/<?= $success_gallery[0]->image ?>">
                                        ...
                                        <input type="hidden" class="form-control" id="id"
                                               name="id" value="<?= $success_gallery[0]->id ?>">
                                        <input type="hidden" class="form-control" id="id"
                                               name="old_image" value="<?= $success_gallery[0]->image ?>">
                                        <div class="form-group">
