                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="panel-title">Edit Person Info</h2>
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" method="post" enctype="multipart/form-data"
                                          action="<?= site_url('admin/person_edit_post')?>">
                                        <div class="form-group">
                                            <label for="control-label col-md-3">Image</label>

                                            <input onchange="readURL(this);" type="file" id="slider_image"
                                                   class="dropify" name="image" data-default-file="<?= base_url() ?>assets/images/person/<?= $person_info[0]->image ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="name"
                                                       name="name" value="<?= $person_info[0]->name ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="designation"
                                                       name="designation" value="<?= $person_info[0]->designation ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"><span style="color: red">*</span>Message</label>
                                            <div class="col-md-8">
                                                <textarea class="summernote" value="" name="message" id="message"
                                                          data-plugin-summernote
                                                          data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'><?= $person_info[0]->message ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"><span style="color: red">*</span>
                                                Address</label>
                                            <div class="col-md-8">
                                                <textarea class="summernote" name="address" value="" id="address"
                                                          data-plugin-summernote
                                                          data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'><?= $person_info[0]->address ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" onkeyup="checkNumber(this.id)"
                                                       ...
                                                       name="phone" value="<?= $person_info[0]->phone ?>">
                                            </div>
                                        </div>
                                        <input type="hidden" class="form-control" id="id"
                                               name="id" value="<?= $person_info[0]->id ?>">
                                        <div class="form-group">
