...
<html>
<head>
	<title>Shaheed Cadet Academy</title>
	<meta charset="utf-8">
	...
	<div class="sticky-wrapper">
		<div class="sticky-menu">
						...
						<ul class="clear-fix">
							...
							<li>
								...
								<ul class="sub-menu">
									...
									<li><a href="#">Daily Food Menu</a></li>
								</ul>
								<!-- / sub mega menu -->
							</li>
							<li>
								...
								<!-- sub menu -->
								<ul class="sub-menu">
									<li><a href="courses-grid.html">Message from Chairman</a></li>
									<li><a href="courses-list.html">Message from MD</a></li>
									<li><a href="courses-single-item.html">Message from DMD</a></li>
								</ul>
								<!-- / sub menu -->
							</li>
							<li>
							...
							<li>
								...
								<!-- sub menu -->
								<ul class="sub-menu">
									<li><a href="event-calendar.html">Rules & Facilities</a></li>
									<li><a href="events-single-item.html">Residential Facilities</a></li>
									<li><a href="event-calendar.html">Parents Responsibilites</a></li>
								</ul>
								<!-- / sub menu -->
							</li>
							<li>
								...
								<!-- sub menu -->
								<ul class="sub-menu">
									<li><a href="shop-product-list.html">Bangla Version</a></li>
									<li><a href="shop-single-product.html">English Version</a></li>
								</ul>
								<!-- / sub menu -->
							</li>
							<li>
								<a style="cursor:text">Branch</a>
								<!-- sub menu -->
								<ul class="sub-menu">
									<li><a href="">Boy's Branch</a></li>
								</ul>
								<!-- / sub menu -->
							</li>
							<li>
								<a href="">Download</a>
								<ul class="sub-menu">
									<li><a href="event-calendar.html">Weekly Result</a></li>
									<li><a href="events-single-item.html">Weekly Syllabus</a></li>
									<li><a href="event-calendar.html">Class Routine</a></li>
									<li><a href="event-calendar.html">Term Result</a></li>
									<ul class="sub-sub-menu">
										<li><a href="">1st Term</a></li>
										<li><a href="">2nd Term</a></li>
										<li><a href="">3rd Term</a></li>
									</ul>
								</ul>
							</li>
							<li>
			...
			<div class="grid-row clear-fix bottom-bar">
				<div class="">
					<p>
						<strong style="color:white;">Shaheed Cadet Academy</strong> Mirpur Branch
					</p>
				</div>
			</div>
		</div>
	...
	<div class="tp-banner-slider">
		<ul>
			<li data-masterspeed="700">
				<img src="img/slider1.jpg" data-lazyload="img/slider1.jpg" alt>
			...
			<li data-masterspeed="700">
				<img src="img/bg-header.jpg" data-lazyload="img/bg-header.jpg" alt>
				<div class="tp-caption sl-content align-right" data-x="['right','center','center','center']"
					 data-hoffset="20" data-y="center" data-voffset="0" data-width="['720px','600px','500px','300px']"
					 data-transform_in="opacity:0;s:1000;e:Power2.easeInOut;"
					 data-transform_out="opacity:0;s:300;s:1000;" data-start="400">
					<div class="sl-title">Forward. Thinking.</div>
					<p>Aenean viverra lobortis purus, sed eleifend nisl egestas in<br/>Proin lacus augue, ornare quis
						nunc vel</p>
			...
			<li data-masterspeed="700" data-transition="fade">
				...
				<div class="tp-caption sl-content align-left" data-x="['left','center','center','center']"
					 data-hoffset="20" data-y="center" data-voffset="40" data-width="['720px','600px','500px','300px']"
					 data-transform_in="opacity:0;s:1000;e:Power2.easeInOut;"
					 data-transform_out="opacity:0;s:300;s:1000;" data-start="400">
		...
		<div class="grid-row clear-fix">
			<div class="grid-col-row">
				...
				<div class="grid-col grid-col-6 clear-fix">
					<h2>Our Services</h2>
					<p>Donec sollicitudin lacus in felis luctus blandit. Ut hendrerit mattis justo at susp. Vivamus orci
						urna, ornare vitae tellus in, condimentum imperdiet eros. Maecea accumsan, massa nec vulputate
	...
	<section class="padding-section">
		<div class="grid-row clear-fix">
			<div class="grid-col-row">
				...
				<div class="grid-col grid-col-6">
					<h2>We Offer</h2>
					<p>Donec sollicitudin lacus in felis luctus blandit. Ut hendrerit mattis justo at suscipit. Vivamus
			...
			<div class="grid-col-row">
				<div class="grid-col grid-col-6">
					...
					<div class="accordions">
						...
						<!--/content-title -->
						<!-- accordions content -->
						<div class="content">Nullam elementum tristique risus nec pellentesque. Pellentesque bibendum
		...
		<div class="grid-row clear-fix">
			<div class="grid-col-row">
				...
				<div class="grid-col grid-col-6 clear-fix">
					...
					<br/>
					<br/>
					<a href="page-about-us.html" class="cws-button bt-color-3 border-radius alt icon-right float-right">Watch
		...
		<div class="grid-row">
			...
			<div class="owl-carousel testimonials-carousel">
				<div class="gallery-item">
					<div class="quote-avatar-author clear-fix"><img src="http://placehold.it/94x94"
																	data-at2x="http://placehold.it/94x94" alt="">
						<div class="author-info">Karl Doe<br><span>Writer</span></div>
					</div>
					<p>Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula,
		...
		<div class="grid-col-row clear-fix">
			...
			<section class="col-sm-3 col-xs-6 footer-payments">
				...
				<article>
					<p>
						<a href="">
							<img class="center-block" src="img/bkash_logo.png" alt="bkash payment" style="border:1px solid white;background-color:white;">
						</a>
					</p>
					<p><strong style="color:white;">Pay to any of the following number:</strong></p>
					<p style="padding-left:25px; color:#78caff;">01714 359692<br>
						01671 503680<br>
						01712 696226
					</p>
				</article>
			...
			<section class="col-sm-3 col-xs-6 footer-contact">
				...
				<div class="textwidget">
					<p  style="color:#78caff;"><strong style="color:white;">Shahid Cadet Academy</strong><br>
						House#38, (Boy's), House#33 (Girls), Road#01, Sector#09, Uttara, Dhaka-1230. Bangladesh.</p>
					<p style="color:#78caff;">Phone: +88 02 8961549</p>
					<p style="color:#78caff;">Cell: +88 01714 359692<br>
						+88 01712 696226<br>
						+88 01919 222234</p>
					<p style="color:#78caff;">Web: www.shahidcadet-academy.com</p>
				</div>
			</section>
