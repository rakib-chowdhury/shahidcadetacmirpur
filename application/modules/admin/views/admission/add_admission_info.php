                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="panel-title">Add Admission Info</h2>
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" method="post"
                                          action="admission_add_post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" required id="admission_start"
                                                       name="admission_start" placeholder="Admission Start">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" required id="class_start"
                                                       name="class_start" placeholder="Class Start">
                                            </div>
                                        </div>
                                        <div class="form-group">
