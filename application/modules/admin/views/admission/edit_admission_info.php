    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Admission Info</span></li>
            </ol>
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="panel-title">Edit Admission Info</h2>
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" method="post" enctype="multipart/form-data"
                                          action="<?= site_url('admin/admission_edit_post')?>">
                                        <div class="form-group">
                                            <label for="control-label col-md-3">Image</label>

                                            <input onchange="readURL(this);" type="file" id="slider_image"
                                                   class="dropify" name="image" data-default-file="<?= base_url() ?>assets/images/admission_info/<?= $admission_info[0]->image ?>">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="admission_start"><span
                                                    style="color: red">*</span>Admission Start</label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" required id="admission_start"
                                                       name="admission_start" value="<?= $admission_info[0]->admission_start ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="class_start"><span
                                                    style="color: red">*</span>Class Start</label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" required id="class_start"
                                                       name="class_start" value="<?= $admission_info[0]->class_start ?>">
                                            </div>
                                        </div>
                                        <input type="hidden" class="form-control" id="id"
                                               name="id" value="<?= $admission_info[0]->id ?>">
                                        <div class="form-group">
