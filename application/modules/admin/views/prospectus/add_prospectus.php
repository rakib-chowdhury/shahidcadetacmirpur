    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Prospectus Info</span></li>
            </ol>
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="panel-title">Add Prospectus</h2>
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" method="post"
                                          action="prospectus_add_post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="control-label col-md-3">Image</label>

                                            <input required onchange="readURL(this);" type="file" id="prospectus_image"
