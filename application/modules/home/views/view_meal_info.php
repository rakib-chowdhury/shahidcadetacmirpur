                ...
                <div>
                    <table class="table table-bordered table-striped mb-none custom-table">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center"><?= $timing[0]->meal_name . '(' . $timing[0]->time . ')' ?></th>
                            <th style="text-align: center"><?= $timing[1]->meal_name . '(' . $timing[1]->time . ')' ?></th>
                            <th style="text-align: center"><?= $timing[2]->meal_name . '(' . $timing[2]->time . ')' ?></th>
                            <th style="text-align: center"><?= $timing[3]->meal_name . '(' . $timing[3]->time . ')' ?></th>
                            <th style="text-align: center"><?= $timing[4]->meal_name . '(' . $timing[4]->time . ')' ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                        foreach ($page_info as $row) { ?>
                            <tr class="gradeX">
                                <td><?= $row->name ?></td>
                                <td><?= $row->b_details ?></td>
                                <td><?= $row->t1_details ?></td>
                                <td><?= $row->l_details ?></td>
                                <td><?= $row->t2_details ?></td>
                                <td><?= $row->d_details ?></td>
                            </tr>
                        <?php }
                        ?>
