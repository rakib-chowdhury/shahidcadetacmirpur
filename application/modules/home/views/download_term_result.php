            ...
            <section style="border:1px solid #a3a3a3;padding:30px;">
                ...
                <div class="col-lg-12" style="padding:10px;">
                    <form action="<?= base_url() ?>home/<?= $a ?>" method="post">
                        ...
                        <div class="col-md-3">
                            <label for="medium" style="font-size: medium">Term</label>
                        ...
                        <div class="col-md-1">
                            <button type="submit" name='submit' value='1' style='margin-top: 60%;margin-left: 970%;'
                                    class='button-color btn btn-raised'>Submit
                            </button>
                        </div>
                    </form>
                </div>
                        ...
                        <table class="table table-bordered table-striped mb-none custom-table" id="datatable-default">
                            ...
                            <?php if ($content == null) {
                                ...
                                <?php foreach ($content as $row) { ?>
                                    <tr class="gradeX">
                                        <td>
                                            <a href="<?= base_url() ?>assets/downloads/term_results/<?= $row->term_result ?>">Download
                                                Term Result
                                                For <?= $row->batch_name . ' ' ?><?= ' ' . $row->medium . ' ' ?>
                                                Medium</a></td>
                                    </tr>
                                <?php }
                            } ?>
