...
class Ion_auth
{
	 ...
	 * getdata_array
         * 
	 * @param string table name
	 * @return a pure array, or an empty array
	 * @author Tanveer Ahmed Ivan
	 **/
        function getdata_array($table)
        {
	 ...
	 * @author Tanveer Ahmed Ivan
	 **/        
        function getdata_where($where=array(),$table)
        {
	 ...
	 * @author Tanveer Ahmed Ivan
	 **/        
        public function inputdata($table,$data=array())
        {
	 ...
	 * @author Tanveer Ahmed Ivan
	 **/
        public function updatedata($where=array(),$table,$data=array())
        {
            $this->db->where($where);
	 ...
	 * @author Tanveer Ahmed Ivan
	 **/
        function deletedata($where=array(),$table)
        {
            $this->db->where($where);
         ...
         */
        public function user_has_access($method , $users_groups = FALSE, $id = FALSE)
        {
            $id || $id = $this->session->userdata('user_id');
            $users_groups || $users_groups = $this->ion_auth_model->get_users_groups($id)->result();
            ...
            foreach($users_groups as $group)
            {
                ...
                $pages = explode('|', $group->access);
                $accessPages = array_merge($accessPages, $pages);
            }
            if(in_array($method, $accessPages))
            {
                return true;
            }
            return false;
         ...
         * @author M Fazle Rabby Khan
         */
        public function user_access_pages( $users_groups = FALSE, $id = FALSE)
        {
            $id || $id = $this->session->userdata('user_id');
            $users_groups || $users_groups = $this->ion_auth_model->get_users_groups($id)->result();
